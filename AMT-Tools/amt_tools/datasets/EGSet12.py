...
class EGSet12(TranscriptionDataset):
    """
    ...
    def get_tracks(self, split):
        ...
        jams_dir = os.path.join(self.base_dir, 'jams')
        ...
        split_start = int(split) * 2
        # Slice the appropriate tracks
        tracks = tracks[split_start : split_start + 2]
    ...
    def get_wav_path(self, track):
        ...
        wav_path = os.path.join(self.base_dir, 'audios', track + '.' + tools.WAV_EXT)
    ...
    def get_jams_path(self, track):
        ...
        jams_path = os.path.join(self.base_dir, 'jams_corrected', f'{track}.{tools.JAMS_EXT}')
